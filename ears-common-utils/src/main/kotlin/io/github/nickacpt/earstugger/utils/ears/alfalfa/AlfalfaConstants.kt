...
import io.github.nickacpt.earstugger.utils.ears.alfalfa.codecs.image.PngImageDataCodec
...
object AlfalfaConstants {
    ...
    private const val WING_KEY_NAME = "wing"
    ...
    @JvmStatic
    val WING_KEY: AlfalfaTypedKey<ImageData> = AlfalfaTypedKey(WING_KEY_NAME, PngImageDataCodec())
